...
// u8 han_width;    //汉字宽度
// u8 height;       //汉字字符高度
// u8 char_num;     //字符字库16进制个数
// u8 han_num;      //汉字字库16进制个数
//}SIZE;
//extern SIZE CharSize[3];
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
...
//extern uchar const ASC_MSK_24[96*48];
//extern struct ASC_MSK_48	const ASC_48[];
...
extern void LCD_display_char24(u16 Row_addr,u16 Col_addr,u16 forecolor,u16 backcolor,char *Str,...);
extern void LCD_display_char64(u16 Row_addr,u16 Col_addr,u16 forecolor,u16 backcolor,char *Str,...);
